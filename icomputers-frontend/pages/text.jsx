...
export default function TextPage() {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-primary text text-secondary">

      <div className="w-[300px] h-[300px] border-[6px] flex justify-center items-center text-5xl">{emotion}</div>
